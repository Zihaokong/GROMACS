...
time mpirun -np 120 -genv i_mpi_pin_domain=omp:compact -genv omp_num_threads=4  gmx_mpi mdrun -s production.tpr -g md_replica_rank150_1.log -o md_replica_rank150_1.trr -e md_replica_rank150_1.edr
